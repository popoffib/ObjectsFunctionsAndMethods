...
def two_circles():
    ...
    circle2 = rg.Circle(rg.Point(200, 200), 100)
...
def lines():
    ...
    # ------------------------------------------------------------------
    window = rg.RoseWindow(400, 450)

    start1 = rg.Point(105, 110)
    ...
    start2 = rg.Point(250, 300)
    end2 = rg.Point(350, 400)
