...
def try_methods():
    ...
    ####################################################################
    new_turtle = rg.SimpleTurtle()
    new_turtle.pen = rg.Pen('brown', 5)
...
def try_methods_and_functions():
    ...
    another_turtle.pen = rg.Pen('blue', 5)

    another_turtle.backward(150)
    another_turtle.speed = 1
    draw_many_squares(another_turtle, 2, 100, 30)

    another_turtle.speed = 5
    another_turtle.pen = rg.Pen('red', 5)
    draw_many_squares(another_turtle, 10, 50, 15)

    another_turtle.speed = 100
    another_turtle.pen = rg.Pen('red', 35)
    draw_many_squares(another_turtle, 8, 300, 60)

    another_turtle.pen = rg.Pen('black', 3)
    another_turtle.backward(200)
    another_turtle.draw_circle(30)
    another_turtle.draw_square(50)
