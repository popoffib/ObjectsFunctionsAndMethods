...
#                outline_thickness, outline_color, fill_color
#
#     f. What does a RoseWindow RENDER method do?
#            It shows the objects attached to the window.
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            It's necessary every time you create a window and attach objects to the window. Otherwise, it would open
#           close immediately.
#
